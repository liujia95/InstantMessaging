...
public class FriendListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public FriendListAdapter(List<FriendInfoBean> datas) {
        mDatas = datas;
        mSystemDatas.add(new FriendInfoBean(R.drawable.em_add_public_group, UIUtils.getString(R.string.apply_and_notification)));
        mSystemDatas.add(new FriendInfoBean(R.drawable.em_groups_icon, UIUtils.getString(R.string.group_chat)));
        mSystemDatas.add(new FriendInfoBean(R.drawable.em_groups_icon, UIUtils.getString(R.string.chat_room)));
        mSystemDatas.add(new FriendInfoBean(R.drawable.em_groups_icon, UIUtils.getString(R.string.huanxin_helper)));
